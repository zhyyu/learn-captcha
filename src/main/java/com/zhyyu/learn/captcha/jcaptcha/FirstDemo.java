package com.zhyyu.learn.captcha.jcaptcha;
...
public class FirstDemo {
	...
	public static void main(String[] args) throws ImageFormatException, IOException {
		String captchaId = "myid";
		
		ImageCaptchaService imageCaptchaService = getImageCaptchaService();
		...
		File file = new File("D:/jcaptcha.jpeg");
		if (!file.exists()) {
			file.createNewFile();
		}
	...
	static ImageCaptchaService getImageCaptchaService() {
